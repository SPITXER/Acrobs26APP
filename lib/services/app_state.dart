...
class AppState extends ChangeNotifier {
  ...
  Future<void> seedTestScrolls() async {
    ...
    final seeds = [
      ...
      // ── Non-legendary Hall scrolls (rank 3–7) ─────────────────────────
      {
        'nomId': 'seed_scroll_004',
        'roomId': 'seed_room_004',
        'title': 'Free Will vs Determinism',
        'thesis': 'If every action is caused by prior events, the notion of free will is a comfortable illusion — not a fact.',
        'category': 'Ethics',
        'hostUid': 'seed_uid_004',
        'hostName': 'Marcus A.',
        'nominatedBy': 'seed_uid_004',
        'nominatedByName': 'The Assembly',
        'ts': now - 3000,
        'originalTs': now - 3000,
        'votes': 25,
      ...
      {
        'nomId': 'seed_scroll_005',
        'roomId': 'seed_room_005',
        'title': 'Language Shapes Reality',
        'thesis': 'We do not describe the world with words — we construct it. Language is not a map of reality; it is the territory.',
        'category': 'Psychology',
        'hostUid': 'seed_uid_005',
        'hostName': 'Elena K.',
        'nominatedBy': 'seed_uid_005',
        'nominatedByName': 'The Assembly',
        'ts': now - 4000,
        'originalTs': now - 4000,
        'votes': 19,
      ...
      {
        'nomId': 'seed_scroll_006',
        'roomId': 'seed_room_006',
        'title': 'The Ethics of Memory Editing',
        'thesis': 'If we could erase traumatic memories, we would lose the very scars that built our character.',
        'category': 'Ethics',
        'hostUid': 'seed_uid_006',
        'hostName': 'Priya N.',
        'nominatedBy': 'seed_uid_006',
        'nominatedByName': 'The Assembly',
        'ts': now - 5000,
        'originalTs': now - 5000,
        'votes': 14,
      ...
      {
        'nomId': 'seed_scroll_007',
        'roomId': 'seed_room_007',
        'title': 'Can Art Be Immoral?',
        'thesis': 'A painting does not murder. A poem does not steal. To call art immoral is to confuse the symbol with the act.',
        'category': 'Art',
        'hostUid': 'seed_uid_007',
        'hostName': 'James O.',
        'nominatedBy': 'seed_uid_007',
        'nominatedByName': 'The Assembly',
        'ts': now - 6000,
        'originalTs': now - 6000,
        'votes': 11,
      ...
      {
        'nomId': 'seed_scroll_008',
        'roomId': 'seed_room_008',
        'title': 'Mathematics: Invented or Discovered?',
        'thesis': 'Pi existed before humans. Geometry did not. The question reveals two entirely different disciplines hiding under one word.',
        'category': 'Mathematics',
        'hostUid': 'seed_uid_008',
        'hostName': 'Yuki T.',
        'nominatedBy': 'seed_uid_008',
        'nominatedByName': 'The Assembly',
        'ts': now - 7000,
        'originalTs': now - 7000,
        'votes': 7,
